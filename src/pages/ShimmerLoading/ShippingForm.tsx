...
const ShippingForm: React.FC = () => {
  return (
    <form className="w-100 w-md-50 py-4 px-3 px-md-5 d-flex flex-column justify-content-start align-items-center gap-3">

  {/* Note Box */}
  <div className="w-100 border border-black rounded p-3 d-flex justify-content-start align-items-center gap-2 bg-secondary-subtle">
  ...
  <div className="w-100 d-flex flex-column align-items-start gap-2">
    ...
    <div className="d-flex justify-content-between align-items-center w-100 gap-3 pt-2">
